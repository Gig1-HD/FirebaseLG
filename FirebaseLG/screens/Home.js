                ...
                <View style={styles.card1}>
                    ...
                    <Text style={styles.descricao}>
                        {[
                            ...
                            "Ainda no Firebase, crie um App Web, nomeie e copie o código criado pelo próprio. No VS Code, crie a pasta config e, dentro dela, o arquivo firebase.js. Cole o código do Firebase e, depois dos dois primeiros imports, adicione `import { getAuth } from 'firebase/auth'`. Na última linha do código, adicione `export const auth = getAuth(app);`.",
                            "Cole essas linhas no terminal: \"npm install @react-navigation/native\"; \"npx expo install react-native-screens react-native-safe-area-context\"; \"npm install @react-navigation/native-stack\"; \"npx expo install react-dom react-native-web\".",
